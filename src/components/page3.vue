...
<style lang="scss">
.page3{ background-image: url(../../static/page2bg.png);
  .page3con{ background: url(../../static/page3border.png) 0 0 no-repeat; background-size: cover; padding-top: 360rem; height: 620rem; text-align: center;}
